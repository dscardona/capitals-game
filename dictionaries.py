americas_caribbean = {
    ...
    "Bolivia": "La Paz (exec. and legis.), Sucre (constitutional and judicial)",
    "Brazil": "Brasilia",
    "Chile": "Santiago",
    "Colombia": "Bogota",
    "Ecuador": "Quito",
...
africa = {
    "Algeria": "Algiers",
    "Angola": "Luanda",
    "Benin": "Porto-Novo (official capital, center of Parliament), Cotonou (de facto center of gov., jurisdictional center)",
    "Botswana": "Gaborone",
    ...
    "Eswatini (previously called Swaziland)": "Mbabane (administrative), Lobamba (Legislative and royal capital)",
...
oceania_australia = {
    ...
    "Nauru": "Yaren District (unofficial)",
